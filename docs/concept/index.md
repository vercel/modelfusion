...
`ai-utils.js` is a TypeScript-first library for building AI apps, chatbots, and agents. It provides APIs for [text generation](https://ai-utils.dev/concept/function/generate-text), [tokenization](https://ai-utils.dev/concept/function/tokenize), [embeddings](https://ai-utils.dev/concept/function/embed-text), [transcription](https://ai-utils.dev/concept/function/transcribe-audio), and [image generation](https://ai-utils.dev/concept/function/generate-image). The [vector DB abstraction](https://ai-utils.dev/concept/vector-db) allows you to store and query text embeddings with similarity search.
